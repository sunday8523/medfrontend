...
export default function SecMedTable({ onWithdrawClick }) {
  ...
  const confirmReturn = async (med) => {
    ...
    try {
      await api.post('/return', { med_id: rowKey(med), med_name: med.med_name, amount: val, expire: med.expire ? format(new Date(med.expire), 'yyyy-MM-dd') : '', type: med.type, lotno: med.lotno });
  ...
  return (
    <div className="medicines-table-container">
      ...
      <table className="medicines-table">
        <thead><tr><th>ID</th><th>ชื่อยา</th><th>จำนวน</th><th>ประเภท</th><th>Lot No</th><th>หมดอายุ</th><th>ส่งกลับ</th><th>เบิกยา</th></tr></thead>
        <tbody>
          ...
          }) : <tr><td colSpan={8} style={{ textAlign: 'center' }}>ไม่พบข้อมูลยา</td></tr>}
        </tbody>
      </table>
        ...
        <div className="modal" onClick={e => e.stopPropagation()}>
          ...
          <div className="qr-code-container">
            ...
            <div className="med-info-details">
              ...
              <p><strong>Lot No:</strong>{qrMed.lotno}</p>
